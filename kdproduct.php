                            ...
                            <table class="table table-hover" id="myDataTable">
                                <thead>
                                    <tr class="info">
                                        ...
                                        <th>Danh mục &nbsp;&nbsp;&nbsp;<a class="fa fa-sort"></a></th>
                                ...
                                <tbody>
                                    ...
                                    // require
                                    $sql_lietke_sp = "SELECT * FROM product INNER JOIN catelogy ON catelogy.id_catalog = product.catalog_id WHERE id_kiemduyet = 0";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="list_td aligncenter">
                                                ...
                                                <a href="kiemduyet.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"> <i class="fa fa-check"></i> </a>
                                            </td>
                                        </tr>
