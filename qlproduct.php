                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <!-- &nbsp;&nbsp;&nbsp;<a href="?oder= name && sort=&sort" name="sort"><i class="fa fa-sort"></i></a> -->
                                <thead>
                                    <tr class="info">
                                ...
                                <tbody>
                                    ...
                                    // SELECT * FROM product,category WHERE product.catalog_id= category.id_dm AND product.id='$_GET[id]' LIMIT 1 
                                    ...
                                    $sql_lietke_sp = "SELECT * FROM product,catelogy WHERE product.catalog_id= catelogy.id_dm ORDER BY id DESC";
                                    $query_lietke_sp = mysqli_query($con, $sql_lietke_sp) or die(mysqli_error($con));
                                    $rows = mysqli_fetch_array($query_lietke_sp);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle"><input type="checkbox" name="checkbok[]" class="checkItem" value="<?php echo $row['id']; ?>"></td>
                                            ...
                                            <td style="vertical-align: middle" value="<?php echo $row['catalog_id'] ?>"> <strong><?php echo $rows['name']; ?></strong></td>
                            ...
                            <button class="btn btn-info" id="submit-del" name="submitdel" style="float: left" onclick="return confirm('Bạn chắc chắn muốn xóa')">Xóa</button>
